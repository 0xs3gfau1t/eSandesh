...
export default function ArticlePreviewSm({
  ...
  return (
    <div className="flex p-2 min-w-[30%] max-w-fit bg-white rounded-md shadow-sm hover:shadow-md duration-200 h-32 items-center lg:items-start justify-between gap-4 my-6">
      <Link to={articleUrl}>
