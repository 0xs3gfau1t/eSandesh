...
export default function ArticlePreviewSm({
	...
	return (
		<div className="flex p-4 min-w-[35%] max-w-fit bg-white rounded-lg shadow-sm hover:shadow-xl border-b-2 duration-200 h-32 items-center justify-between my-6">
