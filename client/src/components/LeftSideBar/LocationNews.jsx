    ...
    <div className="group">
      ...
      <ul className="group-hover:visible absolute ml-12 w-48 -mt-10 group-hover:-mt-4 bg-white p-2 leading-loose invisible opacity-0 group-hover:opacity-100 duration-300">
        <li className="hover:font-bold duration-300 pl-2 hover:pl-5 hover:border-rose-700 border-l-4 border-transparent hover:text-rose-700">
          <Link to={"/category/location/province-1"}>प्रदेश १</Link>
        </li>
        <li className="hover:font-bold duration-300 pl-2 hover:pl-5 hover:border-rose-700 border-l-4 border-transparent hover:text-rose-700">
          <Link to={"/category/location/province-2"}>प्रदेश २ (मधेस)</Link>
        </li>
        <li className="hover:font-bold duration-300 pl-2 hover:pl-5 hover:border-rose-700 border-l-4 border-transparent hover:text-rose-700">
          <Link to={"/category/location/province-3"}>प्रदेश ३ (बागमती)</Link>
        </li>
        <li className="hover:font-bold duration-300 pl-2 hover:pl-5 hover:border-rose-700 border-l-4 border-transparent hover:text-rose-700">
          <Link to={"/category/location/province-4"}>प्रदेश ४ (गण्डकी)</Link>
        </li>
        <li className="hover:font-bold duration-300 pl-2 hover:pl-5 hover:border-rose-700 border-l-4 border-transparent hover:text-rose-700">
          <Link to={"/category/location/province-5"}>प्रदेश ५ (लुम्बिनी)</Link>
        </li>
        <li className="hover:font-bold duration-300 pl-2 hover:pl-5 hover:border-rose-700 border-l-4 border-transparent hover:text-rose-700">
          <Link to={"/category/location/province-6"}>प्रदेश ६ (कर्णाली)</Link>
        </li>
        <li className="hover:font-bold duration-300 pl-2 hover:pl-5 hover:border-rose-700 border-l-4 border-transparent hover:text-rose-700">
          <Link to={"/category/location/province-7"}>प्रदेश ७ (महाकाली)</Link>
        </li>
      </ul>
    </div>
  );
