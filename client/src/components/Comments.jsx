        ...
        <div>
                        ...
                        <div key={comment._id} className="flex flex-row p-4 box-border border-4">
                            ...
                            <div className='w-full'>
                                <div className="flex justify-between">
                                    <span className=' justify-start text-sm font-medium'>{comment.user.slice(0,10)}</span>
                                    <div className='flex justify-end w-full space-x-2'>
                                        <span className = "text-xs">{comment.createdAt.slice(0,10)}</span>
            ...
            <div className='w-full'>
                <form onSubmit={handleSubmit}>
                    ...
                    <input className="w-32 text-sm cursor-pointer text-slate-900  py-2 px-2 rounded-full border-0 font-semibold transition-all duration-200 bg-white  hover:bg-slate-200" type="submit" value="Submit" />
                </form>
            </div>
        </div>
    )
